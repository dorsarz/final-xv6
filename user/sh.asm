...
int fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      86:	15e50513          	addi	a0,a0,350 # 11e0 <malloc+0x118>
...
000000000000008e <runcmd>:
{
  ...
  switch (cmd->type)
      ...
      ae:	23670713          	addi	a4,a4,566 # 12e0 <malloc+0x218>
    ...
    panic("runcmd");
      ...
      c6:	12650513          	addi	a0,a0,294 # 11e8 <malloc+0x120>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      e0:	11458593          	addi	a1,a1,276 # 11f0 <malloc+0x128>
      e4:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     114:	0f058593          	addi	a1,a1,240 # 1200 <malloc+0x138>
     118:	4509                	li	a0,2
    ...
    if (fork1() == 0)
     ...
     176:	09e50513          	addi	a0,a0,158 # 1210 <malloc+0x148>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while (peek(ps, es, "<>"))
     ...
     4d0:	d6ca8a93          	addi	s5,s5,-660 # 1238 <malloc+0x170>
  {
  ...
  while (peek(ps, es, "<>"))
     ...
     4e2:	d3a50513          	addi	a0,a0,-710 # 1218 <malloc+0x150>
...
parseexec(char **ps, char *es)
{
  ...
  if (peek(ps, es, "("))
     ...
     59e:	ca660613          	addi	a2,a2,-858 # 1240 <malloc+0x178>
  ...
  while (!peek(ps, es, "|)&;"))
     ...
     5ce:	c96b0b13          	addi	s6,s6,-874 # 1260 <malloc+0x198>
  {
  ...
  return ret;
     ...
     5f8:	c5450513          	addi	a0,a0,-940 # 1248 <malloc+0x180>
  ...
  while (!peek(ps, es, "|)&;"))
    ...
    if (argc >= MAXARGS)
     ...
     64a:	c0a50513          	addi	a0,a0,-1014 # 1250 <malloc+0x188>
...
000000000000066c <parsepipe>:
{
  ...
  if (peek(ps, es, "|"))
     ...
     688:	be460613          	addi	a2,a2,-1052 # 1268 <malloc+0x1a0>
     68c:	85ce                	mv	a1,s3
     68e:	854a                	mv	a0,s2
...
00000000000006c6 <parseline>:
{
  ...
  while (peek(ps, es, "&"))
     ...
     6e4:	b90a0a13          	addi	s4,s4,-1136 # 1270 <malloc+0x1a8>
  ...
  if (peek(ps, es, ";"))
     ...
     70e:	b6e60613          	addi	a2,a2,-1170 # 1278 <malloc+0x1b0>
     712:	85ce                	mv	a1,s3
     714:	854a                	mv	a0,s2
...
000000000000074e <parseblock>:
{
  ...
  if (!peek(ps, es, "("))
     ...
     764:	ae060613          	addi	a2,a2,-1312 # 1240 <malloc+0x178>
  ...
  if (!peek(ps, es, ")"))
     ...
     788:	b0c60613          	addi	a2,a2,-1268 # 1290 <malloc+0x1c8>
     78c:	85ca                	mv	a1,s2
     78e:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     7be:	ac650513          	addi	a0,a0,-1338 # 1280 <malloc+0x1b8>
     7c2:	889ff0ef          	jal	4a <panic>
    panic("syntax - missing )");
     7c6:	00001517          	auipc	a0,0x1
     7ca:	ad250513          	addi	a0,a0,-1326 # 1298 <malloc+0x1d0>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch (cmd->type)
     ...
     7f2:	b0a70713          	addi	a4,a4,-1270 # 12f8 <malloc+0x230>
...
0000000000000852 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     87e:	95e60613          	addi	a2,a2,-1698 # 11d8 <malloc+0x110>
     882:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     8ac:	a0858593          	addi	a1,a1,-1528 # 12b0 <malloc+0x1e8>
     8b0:	4509                	li	a0,2
     8b2:	738000ef          	jal	fea <fprintf>
    panic("syntax");
     8b6:	00001517          	auipc	a0,0x1
     8ba:	99250513          	addi	a0,a0,-1646 # 1248 <malloc+0x180>
...
00000000000008c2 <main>:
{
  ...
  while ((fd = open("console", O_RDWR)) >= 0)
     ...
     8d6:	9ee48493          	addi	s1,s1,-1554 # 12c0 <malloc+0x1f8>
     8da:	4589                	li	a1,2
     8dc:	8526                	mv	a0,s1
  ...
  while (getcmd(buf, sizeof(buf)) >= 0)
    ...
    if (buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' ')
     ...
     970:	95c58593          	addi	a1,a1,-1700 # 12c8 <malloc+0x200>
     974:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     cdc:	63850513          	addi	a0,a0,1592 # 1310 <digits>
     ce0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     f72:	3a2b8b93          	addi	s7,s7,930 # 1310 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     ...
     fc0:	31c90913          	addi	s2,s2,796 # 12d8 <malloc+0x210>
        for(; *s; s++)
